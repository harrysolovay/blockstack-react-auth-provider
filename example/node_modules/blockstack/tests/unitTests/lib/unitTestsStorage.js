...
var _proxyquire14 = require('proxyquire');

var _proxyquire15 = _interopRequireDefault(_proxyquire14);
...
function runStorageTests() {
  (0, _tape2.default)('getFile unencrypted, unsigned', function (t) {
    ...
    var _proxyquire = (0, _proxyquire15.default)('../../../lib/storage', { // eslint-disable-line no-shadow
  ...
  (0, _tape2.default)('getFile unencrypted, unsigned - multi-reader', function (t) {
    ...
    var _proxyquire2 = (0, _proxyquire15.default)('../../../lib/storage', { // eslint-disable-line no-shadow
  ...
  (0, _tape2.default)('putFile unencrypted, not signed', function (t) {
    ...
    var _proxyquire3 = (0, _proxyquire15.default)('../../../lib/storage', {
  ...
  (0, _tape2.default)('putFile & getFile encrypted, not signed', function (t) {
    ...
    var _proxyquire4 = (0, _proxyquire15.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, uploadToGaiaHub: uploadToGaiaHub }
    }),
        putFile = _proxyquire4.putFile;

    var _proxyquire5 = (0, _proxyquire15.default)('../../../lib/storage', { // eslint-disable-line no-shadow
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, getFullReadUrl: getFullReadUrl }
    }),
  ...
  (0, _tape2.default)('putFile encrypt/no-sign using specifying public key & getFile decrypt', function (t) {
    ...
    var _proxyquire6 = (0, _proxyquire15.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, uploadToGaiaHub: uploadToGaiaHub }
    }),
        putFile = _proxyquire6.putFile;

    var _proxyquire7 = (0, _proxyquire15.default)('../../../lib/storage', { // eslint-disable-line no-shadow
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, getFullReadUrl: getFullReadUrl }
    }),
  ...
  (0, _tape2.default)('putFile & getFile encrypted, signed', function (t) {
    ...
    var _proxyquire8 = (0, _proxyquire15.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, uploadToGaiaHub: uploadToGaiaHub }
    }),
        putFile = _proxyquire8.putFile;

    var _proxyquire9 = (0, _proxyquire15.default)('../../../lib/storage', { // eslint-disable-line no-shadow
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, getFullReadUrl: getFullReadUrl },
  ...
  (0, _tape2.default)('putFile & getFile unencrypted, signed', function (t) {
    ...
    var _proxyquire10 = (0, _proxyquire15.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, uploadToGaiaHub: uploadToGaiaHub }
    }),
        putFile = _proxyquire10.putFile;

    var _proxyquire11 = (0, _proxyquire15.default)('../../../lib/storage', { // eslint-disable-line no-shadow
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, getFullReadUrl: getFullReadUrl },
      '../profiles': { lookupProfile: lookupProfile }
    }),
  ...
  (0, _tape2.default)('promises reject', function (t) {
    ...
    var _proxyquire12 = (0, _proxyquire15.default)('../../../lib/storage', {
  ...
  (0, _tape2.default)('getUserAppFileUrl', function (t) {
    ...
    var _proxyquire13 = (0, _proxyquire15.default)('../../../lib/storage', {
      '../profiles': { lookupProfile: lookupProfile }
    }),
        getUserAppFileUrl = _proxyquire13.getUserAppFileUrl;
